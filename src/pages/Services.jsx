...
const Services = () => {
  return (
    <div id="services" className='py-20 bg-white mt-15'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-12'>
           {
            services.map((service, index)=>(
                <div key={index} className='rounded-xl p-12 border border-primary flex flex-col md:flex-row items-center gap-6 hover:scale-105 transition duration-300 cursor-pointer'>
                    <div className='shrink-0 w-20 aspect-square border-4 border-primary/30 rounded-full flex items-center justify-center '>
